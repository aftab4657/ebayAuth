...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
                        ...
                        <ul class="nav navbar-nav">
                          ...
                          <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu" role="menu">
                              <li class="active"><a href="/amazon" class="disabled">Amazon Products</a></li>
        ...
        <div class="container">          
            <div class="row">
                <div class="col-md-8">
                        <h4>Import data from Amazon Store</h4>
                        <div class="form-group">
                            <label class="control-label">Please paste amazon product link.</label>
                            <div class="input-group">
                            <input type="url" name="url" id="url" placeholder="https://www.amazon.com" class="form-control">
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        window.mainPageTitle = 'Import Amazon Products';
            ShopifyApp.ready(function() {
                ShopifyApp.Bar.initialize({
                    title: 'Import Amazon Products'
                })
            });
    </script>
@endsection